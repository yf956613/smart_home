...
#define KeRanQiYanWu_Alarm_BYTEOFFSET                    7
#define KeRanQiYanWu_Alarm_BITOFFSET                     0
#define KeRanQiYanWu_Alarm_LEN                           1
#define FangDaoBaojin_BYTEOFFSET                    7
...
typedef struct {
  bool valueFangDaoBaoJin_SW;
  bool valueLED_ON_OFF;
  bool valueSocket_ON_OFF;
  bool valueCurtain;
  uint32_t valuetemperature;
  uint32_t valuehumidity;
  uint32_t valueAirQuality;
  uint32_t valueKeRanQiYanWu;
  bool valueKeRanQiYanWu_Alarm;
  bool valueFangDaoBaojin;
} dataPoint_t;
