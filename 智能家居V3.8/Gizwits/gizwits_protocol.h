...
* @{
*/
#define PRODUCT_KEY "fb4bccd25b5342c9b14741b72d7eea27"
/**@} */
/**@name Product Secret  
* @{
*/
#define PRODUCT_SECRET "ae429351457a4ac2a575566b4d641e9e"
...
* @{
*/
#define FangDaoBaoJin_SW_BYTEOFFSET                    0
#define FangDaoBaoJin_SW_BITOFFSET                     0
#define FangDaoBaoJin_SW_LEN                           1
#define LED_ON_OFF_BYTEOFFSET                    0
#define LED_ON_OFF_BITOFFSET                     1
#define LED_ON_OFF_LEN                           1
#define Socket_ON_OFF_BYTEOFFSET                    0
#define Socket_ON_OFF_BITOFFSET                     2
#define Socket_ON_OFF_LEN                           1
#define Curtain_BYTEOFFSET                    0
#define Curtain_BITOFFSET                     3
#define Curtain_LEN                           1
#define Door_SW_BYTEOFFSET                    0
#define Door_SW_BITOFFSET                     4
#define Door_SW_LEN                           1
#define Win_SW_BYTEOFFSET                    0
#define Win_SW_BITOFFSET                     5
#define Win_SW_LEN                           1
#define KeRanQiYanWu_Alarm_BYTEOFFSET                    9
#define KeRanQiYanWu_Alarm_BITOFFSET                     0
#define KeRanQiYanWu_Alarm_LEN                           1
#define FangDaoBaojin_BYTEOFFSET                    9
#define FangDaoBaojin_BITOFFSET                     1
#define FangDaoBaojin_LEN                           1
...
#define AirQuality_RATIO                         1
#define AirQuality_ADDITION                      0
#define AirQuality_MIN                           0
#define AirQuality_MAX                           20000
#define KeRanQiYanWu_RATIO                         1
#define KeRanQiYanWu_ADDITION                      0
#define KeRanQiYanWu_MIN                           0
#define KeRanQiYanWu_MAX                           30000
...
typedef struct {
  bool valueFangDaoBaoJin_SW;   //报警功能开关
  bool valueLED_ON_OFF;        //灯开关
  bool valueSocket_ON_OFF;     //插座开关
  bool valueCurtain;           //窗帘开关
  bool valueDoor_SW;           //门开关
  bool valueWin_SW;            //窗开关
  uint32_t valuetemperature;   //温度
  uint32_t valuehumidity;      //湿度
  uint32_t valueAirQuality;    //空气质量
  uint32_t valueKeRanQiYanWu;  //可燃气烟雾
  uint32_t valueLight_intensity;   //光照强度
  bool valueKeRanQiYanWu_Alarm;    //可燃气烟雾报警
  bool valueFangDaoBaojin;         //防盗报警
} dataPoint_t;


/** Corresponding to the protocol "4.10 WiFi module control device" in the flag " attr_flags" */ 
typedef struct {
  uint8_t flagFangDaoBaoJin_SW:1;
  uint8_t flagLED_ON_OFF:1;
  uint8_t flagSocket_ON_OFF:1;
  uint8_t flagCurtain:1;
  uint8_t flagDoor_SW:1;
  uint8_t flagWin_SW:1;
} attrFlags_t;
...
typedef struct {
  ...
  uint16_t valueAirQuality;
  uint16_t valueKeRanQiYanWu;
